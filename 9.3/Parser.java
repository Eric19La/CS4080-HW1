...
//> Challenge 8.1 repl-mode-constructor
...
//> Challenge 9.3 while-loop-depth
    loopDepth++;
    Stmt body;
    try {
      body = statement();
...
//> Challenge 9.3 function-resets-loop-depth
    // A break inside this function body can't jump out through a loop
    // the function happens to be textually nested in.
...
//< check-max-arity
        // Use assignment(), not expression(), so the comma operator
        // doesn't swallow the commas separating arguments.
...
//> Challenge 6.3 error-productions
    // Error productions: a binary operator appearing with no left operand.
